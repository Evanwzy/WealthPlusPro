...
- (void)updateToolbarItems {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        UIImageView *imageView =[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"list_topBg.png"]];
        imageView.frame =CGRectMake(0.0f, 0.0f, 320.0f, 44.0f);
        ...
        UIImageView *imageView =[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"list_topBg.png"]];
        imageView.frame =CGRectMake(0.0f, 0.0f, 320.0f, 44.0f);
        [self.navigationController.toolbar addSubview:imageView];
